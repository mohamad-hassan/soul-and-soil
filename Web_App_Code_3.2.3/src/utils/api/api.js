...
export const getNewsApi = {
    getNews: ({
        ...
        return Api.post(GET_NEWS, { language_id, offset, limit, id, get_user_news, search, category_id, category_slug, subcategory_id, subcategory_slug, slug, tag_id, tag_slug, latitude, longitude, merge_tag, last_n_days, date, year });
    },
}

// 6. FEATURE DATA API
export const getFeatureDataApi = {
    getFeatureData: ({ language_id, offset, limit, slug, latitude, longitude, section_id, isToken, section_limit, section_offset }) => {
        return Api.post(GET_FEATURE_SECTION, { language_id, offset, limit, slug, latitude, longitude, section_id, isToken, section_limit, section_offset });
    },
}
...
export const getVideoNewsApi = {
    getVideoNews: ({ language_id, offset, limit, slug, category_id, category_slug }) => {
        return Api.post(GET_VIDEO, { language_id, offset, limit, slug, category_id, category_slug });
    },
}
