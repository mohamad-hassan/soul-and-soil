                ...
                <div className='flex items-center gap-2'>
                    {
                        ...
                        <div className='flex items-center gap-2'>
                            ...
                            <div className='relative w-[200px]'>
                                ...
                                {
                                    isFilter &&
                                    <ul className='otherCats commonBg flex flex-col gap-3 absolute w-full mt-[2px] p-2 border borderColor commonRadius z-[5]' onMouseLeave={() => setIsFilter(false)}>
                                        {
                                            selectedCate &&
                    ...
                    }
                    {
                        ...
                        <div className='flex items-center gap-2'>
                            <div className='relative w-[200px]'>
                                ...
                                {
                                    isSubCateFilter &&
                                    <ul className='otherCats commonBg flex flex-col gap-3 absolute w-full mt-[2px] p-2 border borderColor commonRadius z-[5]' onMouseLeave={() => setIsSubCateFilter(false)}>
                                        {selectedCateSubCate &&
