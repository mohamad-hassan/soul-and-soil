...
import { currentLangCode, defaultLanguageCode, isLogin, setCateOffset, translate } from '@/utils/helpers';
...
const MobileNav = ({ userRole, handleAlert, totalMorePages, morePagesOffset, setMorePagesOffset, setIsLoadMorePages, morePagesLimit, notificationData, showNotification }) => {
                                                ...
                                                element?.sub_categories?.length > 0 && settingsData?.data?.subcategory_mode === '1' ?
                                                    <>
                                                        <DropdownMenu>
                                                            ...
                                                            <DropdownMenuContent className='w-full bg-white relative' side='bottom' align='start'>
