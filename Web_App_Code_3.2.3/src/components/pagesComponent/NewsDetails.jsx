...
import { calculateReadTime, currentLangCode, defaultLanguageCode, extractTextFromHTML, isLogin, NoDataFound, placeholderImage, translate } from '@/utils/helpers'
...
const NewsDetails = ({ breakingNews }) => {
  ...
  useEffect(() => {
    ...
    if (routerLanguageId) {
      ...
      console.log('routerLanguageId not found =>', routerLanguageId)
    }
                    ...
                    <div className="col-span-12 lg:col-span-8">
                      <div className='flex flex-col gap-8'>
                        <div>
                          {
                            breakingNews ?
                              ...
                              data && data?.data[0]?.category?.category_name &&
                        ...
                        <div className='flex items-center justify-between flex-wrap gap-6 border-y borderColor py-4 sm:py-6'>
                          <div className='flex items-center gap-4 sm:gap-8 flex-wrap'>
                            ...
                            <div className='flex items-center gap-1 textPrimary font-[600]'>
                              ...
                              <span>{data && data?.data[0]?.total_views}</span>
                            </div>
                        ...
                        <div className='relative'>
                          <Image src={data && data?.data[0]?.image} height={0} width={0} alt={data && data?.data[0]?.title} loading='lazy' className='h-auto max-h-[680px] w-full rounded-[10px] object-cover' onError={placeholderImage} />
                          ...
                          />
                          {
                            ...
                            <Link href={{ pathname: `/${currLangCode}/video-news/${data && data?.data[0]?.slug}`, query: { language_id: data && data?.data[0]?.language_id } }} title='detail-page'>
                              <VideoPlayIcon videoSect={true} keyboard={false} url={data && data?.data[0]?.content_value} type_url={data && data?.data[0]?.content_type} />
                            </Link>
                          }
                        </div>
...

                        {
                          ...
                          <CommentSection newsId={data && data?.data?.[0]?.id} isCommentEnabled={data && data?.data?.[0]?.is_comment} />
                        }
