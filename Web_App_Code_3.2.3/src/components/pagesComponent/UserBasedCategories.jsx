...
import { NoDataFound, placeholderImage, setCateOffset, translate, defaultLanguageCode, currentLangCode } from '@/utils/helpers';
                                                ...
                                                return <div className='flex items-center justify-between border borderColor rounded-[10px] p-2 gap-3 sm:p-4 sm:gap-0 md:p-2 md:gap-3 lg:p-4 lg:gap-0' key={element?.id}>
                                                    ...
                                                    <div>
                                                        ...
                                                        >
                                                            ...
                                                            ></div>
                                                            <span className={`absolute ltr:right-[12px] rtl:left-[12px] font-semibold text-white text-sm transition-opacity duration-300 ${element?.isToggledOn ? 'opacity-0' : 'opacity-100'}`}>OFF</span>
                                                            <span className={`absolute ltr:left-[12px] rtl:right-[12px] font-semibold text-white text-sm transition-opacity duration-300 ${element?.isToggledOn ? 'opacity-100' : 'opacity-0'}`}>ON</span>
                                                        </div>
                                                    </div>
                                                </div>
                                            })
